...
<div class="checkout content-wrapper">
    ...
    <p style="font-size: 15px; margin-left: 25px;" id="alreadyhaveanaccount">Already have an account? <a href="<?=url('index.php?page=myaccount')?>">Log in</a></p>
    <?php endif; ?>
        ...
        <div class="container">
            ...
            <div class="shipping-details">
                ...
                <div class="payment-methods">
                    ...
                    <label for="payondelivery" id="payondelivery">Pay on Delivery</label>
                    <?php endif; ?>

                    <?php if (paypal_enabled): ?>
                    <input id="paypal" type="radio" name="method" value="paypal">
                    <label for="paypal" id="paypal"><img src="https://www.paypalobjects.com/webstatic/mktg/Logo/pp-logo-100px.png" alt="PayPal Logo"></label>
                    <?php endif; ?>

                    <?php if (stripe_enabled): ?>
                    <input id="stripe" type="radio" name="method" value="stripe">
                    <label for="stripe" id="stripe"><i class="fa-brands fa-stripe fa-3x"></i></label>
                    <?php endif; ?>
                    
                    <?php if (coinbase_enabled): ?>
                    <input id="coinbase" type="radio" name="method" value="coinbase">
                    <label for="coinbase" id="coinbase">Cryptocurrency</label>
                    <?php endif; ?>
                </div>
                ...
                <div class="row1">
                    ...
                    <input type="text" value="<?=htmlspecialchars($account['first_name'], ENT_QUOTES)?>" name="first_name" id="first_name" placeholder="Andrei" class="form-field" required>
                </div>

                <div class="row2">
                    <label for="last_name">Last Name</label>
                    <input type="text" value="<?=htmlspecialchars($account['last_name'], ENT_QUOTES)?>" name="last_name" id="last_name" placeholder="Popescu" class="form-field" required>
                </div>
                ...
                <input type="email" name="email" id="email" placeholder="andrei@example.com" class="form-field" required>
            ...
            <div class="cart-details">
                ...
                <h2 style="text-align: center; font-size: 1.75rem">Checkout</h2>

                <table>
                    <?php foreach($products_in_cart as $product): ?>
                    <tr style="border-bottom: 1px solid #EEEEEE;">
                        <td style="display: flex; justify-content: flex-end;"><img src="<?=$product['meta']['img']?>" width="35" height="35" alt="<?=$product['meta']['name']?>"></td>
                ...
                <div class="shipping-methods-container">
                    ...
                    <div class="shipping-methods">
                        <h3 style="font-size: 1.35rem">Shipping Method</h3>
                ...
                <div class="summary" style="padding: 0;">
                    <div class="subtotal">
                        <span>Subtotal:</span>
                ...
                <div class="buttons">
                    <button type="submit" name="checkout" class="btn" style="border: 1px solid black; padding: 15px 15px;">Place Order</button>
                </div>

                <h5 style="text-align: center; margin: 1rem; margin-bottom: 1.5rem; color: red; font-size: 18px;">This is a test website. Do not pay for real.</h5>
