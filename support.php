...
<iframe id="section" src="assets/form.html" width="100%" height="550" postion="relative" bottom="460px" frameborder="0" style="border:0">></iframe>

  <div class="flexbox" style="display: none !important;">

    <div class="topnav5" style="margin-left: -80px;">
      <i style='font-size:18px; color: cornflowerblue' class='far'>&#xf3d1;</i>
      <p1 style="margin-left: 0px; text-align: center;" href="#">Win with Omega Shop</p1>
    </div>

    <div class="topnav6" style="margin-left: 20px;">
      <i style="font-size:18px; color: cornflowerblue" class="fa">&#xf00c;</i>
      <p1 style="margin-left: 0px; text-align: center;" href="#">Guaranteed Authentic</p1>
    </div>

    <div class="topnav7" style="margin-left: 85px; margin-right: -85px;">
      <i style="font-size: 18px; color: cornflowerblue" class="fa">&#xf021;</i>
      <p1 style="margin-left: 0px; text-align: center;" href="#">Free Return</p1>
    </div>
  </div>
