...
<div class="cart content-wrapper">
    ...
    <form action="" method="post">
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="quantity">
                        <input type="number" class="ajax-update" name="quantity-<?=$num?>" value="<?=$product['quantity']?>" value="Update"  min="1" <?php if ($product['meta']['quantity'] != -1): ?>max="<?=$product['meta']['quantity']?>"<?php endif; ?> placeholder="Quantity" required>
                    </td>
                    <td style="text-align: center;">
                    <a href="<?=url('index.php?page=cart&remove=' . $num)?>" style="margin-left: -20px;" class="remove">&#x2715</a>
                    </td>
        ...
        <div class="total">
            ...
            <span class="note" style="font-size: 18px;">(shipping and tax calculated at checkout)</span>
        </div>

        <div class="buttons">
            <input type="submit" id="updateprice" value="Update Price" name="update" class="btn" style="border: 1px solid gainsboro; padding: 15px 60px; display: none;">
            <input type="submit" id="emptycart" value="Empty Cart" name="emptycart" class="btn" style="border: 1px solid gainsboro; padding: 15px 39px; display: none;">
            <input type="submit" id="checkout" value="Checkout" name="checkout" class="btn" style="border: 1px solid black; padding: 15px 120px;">
        </div>
