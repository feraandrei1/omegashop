...
<div class="myaccount content-wrapper" id="settings">
    ...
    <div class="login-register">
        ...
        <div class="login">
            ...
            <form action="" method="post" style="margin-top: -10px;">
                ...
                <input type="email" name="email" id="email" placeholder="andrei@example.com" required class="form-field">

                <label for="password" class="form-label">Password</label>
                <input type="password" name="password" id="password" placeholder="Password" required class="form-field" style="margin-bottom: 15px;">
                
                <a href="/omegashop/index.php?page=register" style="color: lightslategrey;">Sign up</a>
    ...
    <div class="myorders">
        ...
        <div class="order" style="width: 100% !important;">
            <div class="order-header">
                <div>
                    <div style="border-bottom: 1px solid lightgrey; padding: 30px; font-weight: 600;"><span>Order</span> #<?=$transaction['id']?></div>
                    <div class="rhide" style="border-bottom: 1px solid lightgrey; padding-left: 5px; padding: 20px;"><span>Date: </span><?=date('F j Y', strtotime($transaction['created']))?></div>
                    <div style="border-bottom: 1px solid lightgrey; padding-left: 5px; padding: 20px;"><span>Status: </span><?=$transaction['payment_status']?></div>
                </div>
                <div>
                    <div class="rhide" style="border-bottom: 1px solid lightgrey; padding-left: 5px; padding: 20px;"><span>Shipping: </span><?=currency_code?><?=number_format($transaction['shipping_amount'],2)?></div>
                    <div style="padding-left: 5px; padding: 20px;"><span>Total: </span><?=currency_code?><?=number_format($transaction['payment_amount'],2)?></div>
                </div>
            </div>
            <div class="order-items" style="padding: 0px !important;">
                <table>
                    <tbody>
                        <?php foreach ($transactions_items as $transaction_item): ?>
                        <?php if ($transaction_item['txn_id'] != $transaction['txn_id']) continue; ?>
                        <tr style="border-top: 0.5px solid lightgray !important;">
                            <td class="img">
                            ...
                            <td style="text-align: center;" class="price" st><?=currency_code?><?=number_format($transaction_item['price'] * $transaction_item['quantity'],2)?></td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>                
