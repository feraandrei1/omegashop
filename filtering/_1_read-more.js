(function () {
  ...
  function initReadMore(readMore) {
    ...
    var btnShow =
      ...
      "</button>";
    var btnHide =
      ' <button class="js-read-more__btn rh9-hide ' +
      readMore.btnClasses +
      '">' +
  ...
  function resetAppearance(readMore) {
    for (var i = 0; i < readMore.moreContent.length; i++)
      Util.addClass(readMore.moreContent[i], "rh9-hide");
    Util.addClass(readMore.element, "read-more--loaded");
  }
  ...
  function updateVisibility(readMore, visibile) {
    for (var i = 0; i < readMore.moreContent.length; i++)
      Util.toggleClass(readMore.moreContent[i], "rh9-hide", !visibile);
    ...
    if (readMore.ellipsis.length > 0)
      Util.toggleClass(readMore.ellipsis[0], "rh9-hide", visibile);
